...
import static co.edu.udea.certificacion.calidad.userinterfaces.UsuarioPage.TEXT_BANCOLOMBIA_PAGE;
...
public class Validation implements Question<Boolean> {
    ...
    public Boolean answeredBy(Actor actor) {
        ...
        String temp = Text.of(TEXT_BANCOLOMBIA_PAGE).viewedBy(actor).asString();
